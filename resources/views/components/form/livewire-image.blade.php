                ...
                <div
                    ...
                    <div class="col-span-6 sm:col-span-6 mb-2">
                        <input type="file" {{ $multiple ? 'multiple' : '' }} accept="image/*"
                            class="cursor-pointer relative block opacity-0 w-full h-full p-5 z-50"
                            wire:model="{{ $key }}">
                        <div class="text-center p-2 absolute top-0 right-0 left-0 m-auto">
                            <div class="space-y-1 text-center">
                                ...
                                <p class="text-sm text-blue-600">Upload a file or drag
                                    ...
                                    drop
                                    <span
                                        class="font-black text-green-500">{{ $totalNewImagesCount ? '(' . $totalNewImagesCount . ' new images)' : '' }}</span>
                                    <span
                                        class="font-black text-indigo-500">{{ $oldImagesCount ? '(' . $oldImagesCount . ' old images)' : '' }}</span>
                                </p>
                                                ...
                                                @if (is_object($image))
                                                    ...
                                                    @if ($path)
                                                        <div class="relative group flex flex-col-reverse">
                                                            ...
                                                            wire:click="removeFromTotalNewImages({{ $loop->index }})"><svg
                                                                ...
                                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        wire:click="removeFromTotalNewImages({{ $loop->index }})">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            class="h-6 w-6" fill="none"
                                                                            viewBox="0 0 24 24" stroke="currentColor">
                                                                            <path stroke-linecap="round"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex items-start p-4">
                                                            ...
                                                            <button type="button"
                                                                class="relative z-10 bg-red-500 bg-opacity-75 py-1 px-2 rounded-md text-sm text-white opacity-0 group-hover:opacity-100 focus:opacity-100"
                                                                wire:loading.attr="disabled"
                                                                wire:click="removeFromOldImages({{ $loop->index }})">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    class="h-6 w-6" fill="none"
                                                                    viewBox="0 0 24 24" stroke="currentColor">
                                                                    <path stroke-linecap="round" stroke-linejoin="round"
