<x-sidebar.left-sidebar controller="isMobileAccountSidebar">

    <div class="h-full flex flex-col bg-white">
        <div class="bg-indigo-600 text-white text-lg p-3">
            <button
        ...
        <div class="flex-1 border-t border-gray-200 py-3 py-6 overflow-y-auto">
            <div class="flow-root ">
                <div class="py-3 px-5">
                    <div class="flex justify-between mb-5 ">
                        <div class="text-xl font-bold">{{ __('Your Orders') }}</div>
                        <a href="{{ route('profile-info') }}"
                            class="text-green-500 px-1 flex items-center   border-2 rounded">See All</a>
                    </div>


                    <a href="{{ route('profile-info') }}" class="flex items-center text-gray-700 my-5">
                        {{ __('Account') }}
                    </a>

                    <a href="{{ route('my-orders.index') }}" class="flex items-center text-gray-700 my-5">
                ...
                <div class="py-3 px-5">
                    <div class="flex justify-between mb-5 ">
                        <div class="text-xl font-bold">{{ __('Your Account') }}</div>
                        <a href="{{ route('profile-info') }}"
                            class="text-green-500 px-1 flex items-center   border-2 rounded">See All</a>
                    </div>


                    <a href="{{ route('address') }}" class="flex items-center text-gray-700 my-5">
                        {{ __('Address') }}
                    </a>
                ...
                <div class="py-3 px-5">
                    ...
                    {{-- <a href="#" class="flex items-center text-gray-700 my-5">
                        <svg xmlns="http://www.w3.org/2000/svg" id="flag-icon-css-us" viewBox="0 0 640 480" width="20px"
                            height="15px">
                            <g fill-rule="evenodd">
                                <g stroke-width="1pt">
                                    <path fill="#bd3d44"
                        ...
                        <span class="ml-2 block text-base font-medium text-gray-900">
                            English
                        </span>
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button type="submit"
                            class="flex items-center text-gray-700 my-5">{{ __('Log Out') }}</button>
                    </form>
                </div>
            </div>
